      ...
      <main className={styles.main}>
        ...
        <div className={styles.filters__container}>
            <div className={styles.filters__inner__container}>
                ...
                <div className={styles.filter__item} style={{background: filter === "Salada" ? "#C65E4D" : "#fffdf5", color: filter === "Salada" ? "#fffdf5" : "#383434"}} onClick={() => {handleFilterChange("Salada")}}>
                    <p>Saladas</p>
                </div>
                <div className={styles.filter__item2} style={{background: filter === "Dulce" ? "#C65E4D" : "#fffdf5", color: filter === "Dulce" ? "#fffdf5" : "#383434"}} onClick={() => {handleFilterChange("Dulce")}}>
                    <p>Dulces</p>
                </div>
            </div>
        </div>
